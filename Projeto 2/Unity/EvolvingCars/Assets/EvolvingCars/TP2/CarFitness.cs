        ...
        public double Evaluate(IChromosome chromosome)
        {
            ...
            do
            {
                ...
                */
                ...
                //MaxDistance + averageSpeed
                fitness = (float)(MaxDistance + (MaxDistance/MaxDistanceTime));

                //MaxDistance + averageSpeed - CarMass * NumberOfWheels
                //fitness = (float)(MaxDistance + (MaxDistance / MaxDistanceTime) - CarMass);

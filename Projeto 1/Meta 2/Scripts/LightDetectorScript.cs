...
public class LightDetectorScript : MonoBehaviour {
	...
	void Update () {
		...
		//Calcula o valor a devolver pelo sensor, sendo este o resultado da soma da energia recebida de todas as fontes de luz
	...
	public virtual float GetOutputv2() { throw new NotImplementedException(); }
	public virtual float GetOutputv3() { throw new NotImplementedException(); }
